...
const navigation = [
    { name: 'Home', href: '/' },
    { name: 'Resume', href: 'https://drive.google.com/file/d/1smWEpg08BPjBdWc0a387fWGr0dDJzbc9/view?usp=sharing' },
        ...
        <div className="bg-white font-cinzel">
            ...
            <div className="min-h-screen px-10 mt-20 md:px-12 py-16 bg-white dark:bg-black text-black dark:text-white">
                <div className="text-center mb-6">
                    <h1 className="text-4xl font-extrabold mb-6">My Achievements</h1>
                    <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                        Explore some of the achievements I&apos;ve made
                    </p>
                </div>
